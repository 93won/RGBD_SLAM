...
namespace RGBDSLAM
{
    ...
    bool Tracker::Track()
    {
        ...
        current_frame_->SetPose(optimizer_->LocalBundleAdjustment(current_frame_, frame2param));
    ...
    //                 else
    //                 {
    //                     // RelPose = optimizer_->EstimateRelPose2D(frame2param);
    //                     RelPose = optimizer_->EstimateRelPose(frame2param);
